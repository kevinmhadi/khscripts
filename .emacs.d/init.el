...
(global-set-key (kbd "C-x C-j") `redraw-display)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smartparens magit dracula-theme highlight-indent-guides evil eval-in-repl undo-tree term-keys goto-chg)))
 '(pop-up-windows nil)
 '(tool-bar-mode nil)
 '(tooltip-mode nil)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "grey10" :foreground "grey75" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 1 :width normal :foundry "default" :family "default"))))
